...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4Fvursn4wNsUUcRjcWqm"; // AccessKeyId

        $accessKeySecret = "ch2y1d9R96r1bY38LEraNQJl2cV5AN"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($userInfo) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($userInfo['phone']);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("乐柠PHP");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_187952870");
