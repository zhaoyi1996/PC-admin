...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4FtnD9G96jPoSGgpye3F"; // AccessKeyId

        $accessKeySecret = "Euvet9LbnDjHOM8LI8WWS9IIKxuAJq"; // AccessKeySecret
    ...
    public static function sendSms($userInfo) {
        ...
        $request->setSignName("伤心酒馆");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_183266651");
