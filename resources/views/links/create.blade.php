...
<form class="layui-form" action="/links/add" method="post">
    @csrf
    <div class="layui-form-item">
        <label class="layui-form-label">链接名称</label>
        <div class="layui-input-inline">
            <input type="text" name="l_name" required  lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="l_url" required  lay-verify="required"
